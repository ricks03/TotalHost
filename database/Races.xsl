				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>RaceDescrip</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>User_File</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="Races">
							...
							<tr>
								<td>
									<xsl:value-of select="RaceID"/>
								</td>
								<td>
									<xsl:value-of select="RaceFile"/>
								</td>
								<td>
									<xsl:value-of select="RaceName"/>
								</td>
								<td>
									<xsl:value-of select="User_Login"/>
								</td>
								<td>
									<xsl:value-of select="RaceDescrip"/>
								</td>
								<td>
									<xsl:value-of select="User_File"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
